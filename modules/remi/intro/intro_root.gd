...
func start():
	...
	tween_color.tween_property($World/Eclatos, "modulate", Color(0.0, 0.0, 0.0), 1.0).set_trans(Tween.TRANS_QUAD)
	...
	tween_color.parallel().tween_property($World/Eclatos, "modulate:a", 0.0, 0.25).set_trans(Tween.TRANS_QUAD)
	tween_color.tween_property($World/Pigeon, "modulate", Color.WHITE, 0.25).set_trans(Tween.TRANS_QUAD)
